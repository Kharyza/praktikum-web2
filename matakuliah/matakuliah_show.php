          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <a class="btn btn-sm btn-danger" href="../matakuliah/matakuliah_delete.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Yakin ingin menghapus mata kuliah ini?')">Hapus</a>
              </td>
            </tr>
          <?php } ?>
        </tbody>
